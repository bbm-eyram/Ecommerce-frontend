          ...
          <div className="flex flex-1 items-center justify-end md:justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="sm:flex sm:gap-2 border-r border-primary pr-4">
                <div class="h-9 w-9">
                  <img class="h-full w-full rounded-full object-cover object-center" src={session.user.image} alt={session.user.name} />
                </div>
              </div>
            ) : (
              <div className="sm:flex sm:gap-2 border-r border-primary pr-4">
                ...
                <Link
                  className=" text-md font-medium text-text  max-md:flex "
                  href="/"
